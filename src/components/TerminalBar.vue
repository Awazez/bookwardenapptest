...
<div class="terminal alert alert-info p-4 snipcss-kBALP" id="site-list">
  <div class="row mb-3">
    <div class="col-12">
      Hello traveller and bienvenue sur Bookwarden Labs.
      <br>
      <br>
      Vous êtes en train de regarder  une application pour livres avec un moteur de recherche qui va vous permettre de trouver n'importe quel livre !
      <br>
